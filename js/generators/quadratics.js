...
// Converted from TG5 Maths pt II quadratics_module.js — behaviour preserved
import { QLimitRepeats, cfchk, dp, gcd, gcd2, images, rndgen } from '../utils.js';
...
//x^2 always has coefficient of 1 and solutions are always integers.
  ...
  notesLink = "images/20200504-MathsBook5AlgebraicOpsv1_3-APO.pdf#page=15"
  const _result = {
      question: sumq,
      solution: suma,
      notesLink: notesLink
