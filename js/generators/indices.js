...
// Converted from TG5 Maths pt II indices_module.js — behaviour preserved
import { images, rndgen } from '../utils.js';
...
//Also, absolute values of top and bottom index totals can't be the same.
    ...
    notesLink = "images/20240924-TG5MathsBook1-NumeracyV1_0-APO.pdf#page=40";
    const _result = {
      question: sumq,
      solution: suma,
      notesLink: notesLink
