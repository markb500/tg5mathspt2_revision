...
// Converted from TG5 Maths pt II areavol_module.js — behaviour preserved
import { QLimitRepeats, dp, images, rndgen, thouSep } from '../utils.js';
  ...
  const ctx2 = ctx;
    ...
    switch(sum) {
        case 1:     //cubtri 
            ...
            ctx.drawImage(images.cubtri, left, top, 350, 200);
        ...
        case 2:     //cubtritube
            ...
            ctx.drawImage(images.cubtritube, left, top, 350, 200);
            ctx.textAlign = "center";
            ctx.fillText(a + units, left + 145, bottom + 15);   //a
            ctx.textAlign = "right";
            ctx.fillText(d + units, left - 2, (bottom - top) / 2 + 60);  //d
        ...
        case 3:     //2cyl
            ...
            ctx.drawImage(images.twocyl, 75, 25, 350, 200);
            ctx.textAlign = "center";
        ...
        case 4:     //tritube
            ...
            ctx.drawImage(images.tritube, 75, 25, 350, 200);
            ctx.textAlign = "right";
        ...
        case 5:     //rivet
            ...
            ctx.drawImage(images.rivet, left, top, 350, 200);
            ctx.textAlign = "center";
        ...
        case 6:     //domecone
            ...
            ctx.drawImage(images.domecone, left, top, 350, 200);
            ctx.textAlign = "center";
