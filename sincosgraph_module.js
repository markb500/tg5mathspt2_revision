...
function sincosgraph(ctx2) {
  ...
  sumarrsincos = QLimitRepeats(sumarrsincos, 40);   //Ensures no repeat question until at least 50% of questions shown
  ...
  switch(sum) {
    ...
    case 32:
      ...
      break;
    case 33: case 34: case 35: case 36: case 37: case 38: case 39: case 40:  //Examples of finding all angles 0 to 360 using CAST
